...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'books'], function () {
        ...
        Route::get('/{docSlug}/permissions', 'BookController@showRestrict');
        Route::put('/{docSlug}/permissions', 'BookController@restrict');
        Route::get('/{slug}/delete', 'BookController@showDelete');
        Route::get('/{docSlug}/sort', 'BookController@sort');
        Route::put('/{docSlug}/sort', 'BookController@saveSort');
        Route::get('/{docSlug}/export/html', 'BookController@exportHtml');
        Route::get('/{docSlug}/export/pdf', 'BookController@exportPdf');
        Route::get('/{docSlug}/export/plaintext', 'BookController@exportPlainText');
        Route::get('/{docSlug}/export/raw', 'BookController@rawPlainText');

        // Pages
        Route::get('/{docSlug}/page/create', 'PageController@create');
        Route::post('/{docSlug}/page/create/guest', 'PageController@createAsGuest');
        Route::get('/{docSlug}/draft/{pageId}', 'PageController@editDraft');
        Route::post('/{docSlug}/draft/{pageId}', 'PageController@store');
        Route::get('/{docSlug}/page/{pageSlug}', 'PageController@show');
        Route::get('/{docSlug}/page/{pageSlug}/export/pdf', 'PageController@exportPdf');
        Route::get('/{docSlug}/page/{pageSlug}/export/html', 'PageController@exportHtml');
        Route::get('/{docSlug}/page/{pageSlug}/export/plaintext', 'PageController@exportPlainText');
        Route::get('/{docSlug}/page/{pageSlug}/export/raw', 'PageController@rawPlainText');
        Route::get('/{docSlug}/page/{pageSlug}/edit', 'PageController@edit');
        Route::get('/{docSlug}/page/{pageSlug}/move', 'PageController@showMove');
        Route::put('/{docSlug}/page/{pageSlug}/move', 'PageController@move');
        Route::get('/{docSlug}/page/{pageSlug}/delete', 'PageController@showDelete');
        Route::get('/{docSlug}/draft/{pageId}/delete', 'PageController@showDeleteDraft');
        Route::get('/{docSlug}/page/{pageSlug}/permissions', 'PageController@showRestrict');
        Route::put('/{docSlug}/page/{pageSlug}/permissions', 'PageController@restrict');
        Route::put('/{docSlug}/page/{pageSlug}', 'PageController@update');
        Route::delete('/{docSlug}/page/{pageSlug}', 'PageController@destroy');
        Route::delete('/{docSlug}/draft/{pageId}', 'PageController@destroyDraft');

        // Revisions
        Route::get('/{docSlug}/page/{pageSlug}/revisions', 'PageController@showRevisions');
        Route::get('/{docSlug}/page/{pageSlug}/revisions/{revId}', 'PageController@showRevision');
        Route::get('/{docSlug}/page/{pageSlug}/revisions/{revId}/changes', 'PageController@showRevisionChanges');
        Route::get('/{docSlug}/page/{pageSlug}/revisions/{revId}/restore', 'PageController@restoreRevision');

        // Chapters
        Route::get('/{docSlug}/chapter/{chapterSlug}/create-page', 'PageController@create');
        Route::post('/{docSlug}/chapter/{chapterSlug}/page/create/guest', 'PageController@createAsGuest');
        Route::get('/{docSlug}/chapter/create', 'ChapterController@create');
        Route::post('/{docSlug}/chapter/create', 'ChapterController@store');
        Route::get('/{docSlug}/chapter/{chapterSlug}', 'ChapterController@show');
        Route::put('/{docSlug}/chapter/{chapterSlug}', 'ChapterController@update');
        Route::get('/{docSlug}/chapter/{chapterSlug}/move', 'ChapterController@showMove');
        Route::put('/{docSlug}/chapter/{chapterSlug}/move', 'ChapterController@move');
        Route::get('/{docSlug}/chapter/{chapterSlug}/edit', 'ChapterController@edit');
        Route::get('/{docSlug}/chapter/{chapterSlug}/permissions', 'ChapterController@showRestrict');
        Route::get('/{docSlug}/chapter/{chapterSlug}/export/pdf', 'ChapterController@exportPdf');
        Route::get('/{docSlug}/chapter/{chapterSlug}/export/html', 'ChapterController@exportHtml');
        Route::get('/{docSlug}/chapter/{chapterSlug}/export/plaintext', 'ChapterController@exportPlainText');
        Route::get('/{docSlug}/chapter/{chapterSlug}/export/raw', 'ChapterController@rawPlainText');
        Route::put('/{docSlug}/chapter/{chapterSlug}/permissions', 'ChapterController@restrict');
        Route::get('/{docSlug}/chapter/{chapterSlug}/delete', 'ChapterController@showDelete');
        Route::delete('/{docSlug}/chapter/{chapterSlug}', 'ChapterController@destroy');
    });
