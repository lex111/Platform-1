                    ...
                    <div class="float right">
                        <div class="header-search">
                            <form action="{{ baseUrl('/search') }}" method="GET" class="search-box">
                                ...
                                <input id="header-search-box-input" type="text" name="term" tabindex="2" maxlength="32" placeholder="{{ trans('common.search') }}" value="{{ isset($searchTerm) }}" name="message" minlength="3" maxlength="32" required>
                            </form>
                        </div>
