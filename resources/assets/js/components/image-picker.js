class ImagePicker {
  constructor(elem) {
    ...
    this.isResizing =
      elem.getAttribute("data-resize-height") &&
      elem.getAttribute("data-resize-width");
    this.isResizeCropping = elem.getAttribute("data-resize-crop") !== "";

    let selectButton = elem.querySelector(
      'button[data-action="show-image-manager"]'
    );
  ...
  selectImage() {
    window.ImageManager.show(image => {
      ...
      let requestString =
        ...
        image.id +
        "/" +
        this.elem.getAttribute("data-resize-width") +
        "/" +
        this.elem.getAttribute("data-resize-height") +
        "/" +
        (this.isResizeCropping ? "true" : "false");
