class EntitySelector {
  constructor(elem) {
    ...
    let entityTypes = elem.hasAttribute("entity-types")
      ? elem.getAttribute("entity-types")
      : "page,book,chapter";
    this.searchUrl = window.baseUrl(
      `/ajax/search/entities?types=${encodeURIComponent(entityTypes)}`
    );
  ...
  selectItem(item) {
    ...
    let link = item
      .querySelector(".entity-list-item-link")
      .getAttribute("href");
