...
axiosInstance.interceptors.request.use(
  ...
  err => {
    ...
    if (typeof err.response.data.error !== "undefined")
      window.$events.emit("error", err.response.data.error);
    if (typeof err.response.data.message !== "undefined")
      window.$events.emit("error", err.response.data.message);
  }
);
...
window.scrollAndHighlight = function(element) {
  ...
  let color = document
    .getElementById("custom-styles")
    .getAttribute("data-color-light");
  let initColor = window
